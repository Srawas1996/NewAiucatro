...
public class MidnightCucumberScheduler {
    ...
    private static final String PASSWORD = "dghkbhsbtslmhvns";
    // Gmail App Password
    private static final String SMTP_HOST = "smtp.gmail.com";
    private static final String SMTP_PORT = "587"; // --- Paths ---
...
//        }
    ...
    private static String getMavenCommand() {
        ...
        String mvnCommand;
        if (os.contains("win")) { // Windows: try system mvn.cmd first
            mvnCommand = "mvn.cmd"; // Fallback to full local path if not in PATH
    ...
    private static void sendEmailReport() {
        ...
        try {
            ...
            multipart.addBodyPart(textPart); // Attach report
            attachFile(multipart, reportFile); // Attach screenshots
